<div class="modal fade" tabindex="-1" role="dialog" id="modal_dialog_rental_detail">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_title_rental_detail">Rental Detail</h4>
            </div>
            <div class="modal-body form-horizontal" id="modal_content_rental_detail">
                <div class="form-group">
                    <label class="control-label col-sm-3">Date:</label>
                    <div class="col-sm-8 form-control-static" id="dl_rental_date"> </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-3">Name:</label>
                    <div class="col-sm-8 form-control-static" id="dl_renter_name"> </div>
                </div>
                <div class="form-group">
